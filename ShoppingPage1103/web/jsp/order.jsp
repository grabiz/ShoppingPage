    ...
    <body>
        ...
        <table>
                ...
                <c:forEach var="product" items="${sessionScope.prodAddedList}">
                            <tr>
                                <td><input type="checkbox" name="checkbox" value="${product.prodID}"></td>
                                <td>${product.prodName} </td>
                                <td>${product.prodPrice} </td>
                                <td>${product.prodDescription} </td>
                                <td><input type="hidden" name="Quan" value="${product.prodID}">
                                    <input type="number" name="Quantity" value="${quantity[product.prodID]}" min="1"></td>
                                <td>${product.prodPrice*sessionScope.quantity[product.prodID]}</td>
                            </tr>
                </c:forEach>
            </table>
